...
Each of the isospin subamplitudes $\mathcal{A}_I$ admits a partial-wave expansion analogous to that given in \Cref{eq:highendecomp},
\begin{equation}
    \Im \mathcal{A}_I(s,t,u)
    =
...
\begin{equation}
    \begin{split}
        ...
        \left[
            \frac{\Im \mathcal{A}^I(\hat{s}, t)}{\hat{s}^{n+1}}
            + (-1)^n X^{I}_{\ J}\,\frac{\Im \mathcal{A}^J(\hat{s}, t)}{(\hat{s}+u)^{n+1}}
        \right].
    \end{split}
