...
First, we demonstrated that a theory of massless scalars satisfying $-2$-subtracted dispersion relations cannot feature the exchange of a massive resonance with even spin. For scalar fields of mass $M$ obeying the same dispersion relations, the exchange of an even-spin resonance of mass $m$ is permitted only if
\[
m^2 \geq \frac{M^2}{2}.
\]
