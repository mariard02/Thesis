...
First, we demonstrated that a theory of massless scalars satisfying \((-2)\)-subtracted dispersion relations cannot feature the exchange of a massive resonance of any spin. For scalar fields of mass \(m\), the exchange of an even-spin resonance of mass \(M\) is not immediately excluded, provided that
\[
m^2 \geq \frac{M^2}{2}.
\]
However, this condition only ensures compatibility with the simplest positivity constraint. The full set of null constraints is expected to require additional higher-spin states, whose exchanges contribute negatively to the relevant residue. Therefore, the existence of a fully consistent UV completion remains doubtful even in the region \(m^2 \geq M^2/2\).
...
m_0 < m_2,
\]
showing that the exchange of a spin-\(2\) resonance is impossible in the absence of a lighter scalar resonance. Moreover, our numerical analysis provided upper bounds on the coupling of the spin-\(2\) resonance to the external scalar states and reinforced the conclusion that a spin-\(0\) resonance is necessary for a consistent heavier spin-\(2\) state. The numerical bounds also impose stronger constraints on the allowed mass spectrum than those derived analytically. Similar conclusions were obtained for the case of massive scalar external legs.
