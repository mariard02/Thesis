...
Consider again the $2 \to 2$ scattering of massless scalars, and define the arcs as 
\begin{equation}
...
\begin{equation}
    a_{k,k-J_1} = a_{k,J_1}.
\end{equation}
Moreover, positivity of the dispersive representation implies the inequality \textcolor{purple}{EXPLAIN}
\begin{equation}
